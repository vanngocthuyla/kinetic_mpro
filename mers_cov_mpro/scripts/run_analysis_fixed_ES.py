...
for _dir in _mcmc_dir:
    ...
    params_names = {'kcat_DS':      '$k_{cat,DS}$',
                    ...
                    'logKd':        '$logK_d$',
                    'alpha:ESI:0':  '$\\alpha^{E:100nM, S:1350nM}$',
                    'alpha:ESI:1':  '$\\alpha^{E:100nM, S:50nM}$',
                    'alpha:ESI:2':  '$\\alpha^{E:100nM, S:750nM}$',
                    'alpha:ESI:3':  '$\\alpha^{E:50nM, S:150nM}$',
    ...
    try:
        ...
        no_expt = 4
        alphas = jnp.array([dE_alpha[f'alpha:ESI:{i}'] for i in range(no_expt)])
