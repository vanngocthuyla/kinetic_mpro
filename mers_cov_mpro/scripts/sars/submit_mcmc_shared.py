...
ßparser.add_argument( "--set_K_I_M_equal_K_S_M",         action="store_true",    default=False)
...
running_script = "/ocean/projects/mcb160011p/sophie92/python/mers_mpro/scripts/run_mcmc_shared.py"
