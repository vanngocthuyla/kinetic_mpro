...
prior = {}
prior['logKd'] = {'type':'logKd', 'name': 'logKd', 'fit':'global', 'dist': None, 'value': -11.004}
prior['logK_S_M'] = {'type':'logK', 'name': 'logK_S_M', 'fit':'global', 'dist': None, 'value': -11.339} 
prior['logK_S_D'] = {'type':'logK', 'name': 'logK_S_D', 'fit':'global', 'dist': None, 'value': -14.836} 
prior['logK_S_DS'] = {'type':'logK', 'name': 'logK_S_DS', 'fit':'global', 'dist': None, 'value': -1.205} 
prior['logK_I_M'] = {'type':'logK', 'name': 'logK_I_M', 'fit':'global', 'dist': 'uniform', 'value': 0, 'lower': -13.82, 'upper': logKd_max} #1E-6
prior['logK_I_D'] = {'type':'logK', 'name': 'logK_I_D', 'fit':'global', 'dist': 'uniform', 'value': 0, 'lower': logKd_min, 'upper': -6.90}
prior['logK_I_DI'] = {'type':'logK', 'name': 'logK_I_DI', 'fit':'global', 'dist': 'uniform', 'value': 0, 'lower': logKd_min, 'upper': -6.90}
prior['logK_S_DI'] = {'type':'logK', 'name': 'logK_S_DI', 'fit':'global', 'dist': 'uniform', 'value': 0, 'lower': logKd_min, 'upper': -6.90}

prior['kcat_DS'] = {'type':'kcat', 'name': 'kcat_DS', 'fit':'global', 'dist': None, 'value': 5.642}
prior['kcat_DSS'] = {'type':'kcat', 'name': 'kcat_DSS', 'fit':'global', 'dist': None, 'value': 4.894}
...
_error_E = {}
_error_E['dE:100'] = 0.618
_error_E['dE:50'] = 0.314
_error_E['dE:25'] = 0.073

alpha_list = {}
alpha_list['alpha:0'] = 0.727
alpha_list['alpha:1'] = 0.922
alpha_list['alpha:2'] = 0.831
alpha_list['alpha:3'] = 0.918

[map_index, map_params, log_probs] = map_finding(trace, expts, prior_infor_update, alpha_list, _error_E, dE=args.dE)
...
_alpha = jnp.array([0.727, 0.922, 0.831, 0.918])
