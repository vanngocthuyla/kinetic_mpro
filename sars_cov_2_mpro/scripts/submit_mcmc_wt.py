...
running_script = "/ocean/projects/mcb160011p/sophie92/python/mpro/scripts/run_mcmc_wt.py"
...
cd ''' + args.out_dir + '''\n''' + \
    ...
    fit_wildtype_Nashed + fit_wildtype_Vuong + fit_E_S + fit_E_I + multi_var_wt + \
