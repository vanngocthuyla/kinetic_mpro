...
prior = {}
prior['logKd'] = {'type':'logKd', 'name': 'logKd', 'fit':'local', 'dist': ['uniform', 'normal', None], 'loc': [None, -14, None], 'scale': [None, 2, None], 'lower': [-20, None, None], 'upper': [0, None, None], 'value': None}
...
params_logK['logKd:2'] = params_logK['logKd:1']
