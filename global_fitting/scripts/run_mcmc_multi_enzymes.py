...
prior = {}
prior['logKd'] = {'type':'logKd', 'name': 'logKd', 'dist': 'normal', 'loc': -13.5, 'scale': 3.}
prior['logK_S_M'] = {'type':'logK', 'name': 'logK_S_M', 'dist': 'uniform', 'lower': logKd_min, 'upper': logKd_max}
prior['logK_S_D'] = {'type':'logK', 'name': 'logK_S_D', 'dist': 'uniform', 'lower': logKd_min, 'upper': logKd_max}
prior['logK_S_DS'] = {'type':'logK', 'name': 'logK_S_DS', 'dist': 'uniform', 'lower': logKd_min, 'upper': logKd_max}
prior['logK_I_M'] = {'type':'logK', 'name': 'logK_I_M', 'dist': 'uniform', 'lower': logKd_min, 'upper': logKd_max}
prior['logK_I_D'] = {'type':'logK', 'name': 'logK_I_D', 'dist': 'normal', 'loc': -13., 'scale': 3.}
prior['logK_I_DI'] = {'type':'logK', 'name': 'logK_I_DI', 'dist': 'normal', 'loc': -15., 'scale': 3.}
prior['logK_S_DI'] = {'type':'logK', 'name': 'logK_S_DI', 'dist': 'uniform', 'lower': logKd_min, 'upper': logKd_max}
prior['kcat_MS'] = {'type':'kcat', 'name': 'kcat_MS', 'dist': None, 'value': 0.}
prior['kcat_DS'] = {'type':'kcat', 'name': 'kcat_DS', 'dist': None, 'value': 0.}
prior['kcat_DSS'] = {'type':'kcat', 'name': 'kcat_DSS', 'dist': 'uniform', 'lower': kcat_min, 'upper': kcat_max}
prior['kcat_DSI'] = {'type':'kcat', 'name': 'kcat_DSI', 'dist': 'uniform', 'lower': kcat_min, 'upper': kcat_max}
...
for name in ['logK_S_M', 'logK_S_D', 'logK_S_DS']:
    if args.fit_E_S:
        ...
        prior_infor.append({'type':'logK', 'name': name, 'dist': None, 'value': 0})
...
if args.fit_E_S and args.fit_E_I:
    ...
    prior_infor.append({'type':'logK', 'name': 'logK_S_DI', 'dist': None, 'value': 0})
    
for name in ['kcat_MS', 'kcat_DS', 'kcat_DSS']:
    if args.fit_E_S:
        prior_infor.append(dict([(key, prior[name][key]) for key in prior[name].keys()]))
    else: 
        prior_infor.append({'type':'kcat', 'name': name, 'dist': None, 'value': 0})

if args.fit_E_S and args.fit_E_I:
    prior_infor.append(dict([(key, prior['kcat_DSI'][key]) for key in prior['kcat_DSI'].keys()]))
else:
    prior_infor.append({'type':'kcat', 'name': 'kcat_DSI', 'dist': None, 'value': 0})
