...
export SCRIPT="/home/exouser/python/mpro/scripts/submit_CRC.py"
...
export PRIOR='/home/exouser/python/mpro/mers/7.CRC/Prior.json'

export MAP_FILE="/home/exouser/python/mpro/mers/7.CRC/map_sampling.pickle"

export OUT_DIR="/home/exouser/python/mpro/mers/7.CRC"
...
python $SCRIPT --input_file $INPUT --out_dir $OUT_DIR --running_script $RUNNING_SCRIPT --prior_infor $PRIOR --niters $N_INTER --nburn $N_BURN --nchain $N_CHAIN --set_lognormal_dE --dE 0.1 --multi_var --name_inhibitor "$NAME" --map_file $MAP_FILE --split_by $SPLIT_BY