...
if len(args.list_inhibitor)>0:
    list_inhibitor = " --list_inhibitor " + args.list_inhibitor
else:
    list_inhibitor = " "
...
if len(args.map_file)>0: 
    ...
    map_file = " --initial_values " + os.path.join(args.last_run_dir, "map.pickle")
else:
    map_file = " "
...
cd ''' + args.out_dir + '''\n''' + \
    ...
    list_inhibitor + last_run_dir + map_file + ''' --out_dir ''' + args.out_dir + \
